...
public class KeyBinding {
    ...
    public static final String KEY_DEBUG = "key.bizarre_wizardry.debug";
    ...
    public static final KeyMapping DEBUG_KEY = new KeyMapping(KEY_DEBUG, KeyConflictContext.IN_GAME,
